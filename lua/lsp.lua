...
if vim.fn.filereadable("/google/bin/releases/cider/ciderlsp/ciderlsp") then
  configs.ciderlsp = {
    default_config = {
...
-- Disable all diagnostics for now, until I feel like configuring them to not be annoying.
