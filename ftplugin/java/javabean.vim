...
if exists("b:did_javabean_ftplugin")
   finish
endif
let b:did_javabean_ftplugin = 1
...
function! s:GetSetterAndGetters()
  let setter = "public void set" . s:capName . "( " . s:varType . " val )" . "{ " . s:varName . " = val; }"
  let getter = "public " . s:varType . " get" . s:capName . "(){ return " . s:varName . "; }"
