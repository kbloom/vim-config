...
if(exists("b:did_jcommenter_plugin"))
   finish
endif
let b:did_jcommenter_plugin = 1


" map the commenter:
map <Leader>xc :call JCommentWriter()<CR>
...
" mode).
map <Leader>xf :call SearchInvalidComment(0)<cr>
map <Leader>xb :call SearchInvalidComment(1)<cr>
